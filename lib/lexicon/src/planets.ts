...
export interface PlanetEntry {
  ...
  approach: string;
  meaning: string;
  /** The words people use for this planet's weather in themselves — the
   *  vocabulary the "how are you feeling" door mirrors against. Drawn from
   *  each planet's own literacy (its shadow and how its time feels), because
   *  the task keywords in associate.ts describe DOINGS and read "irritable,
   *  snapping at people" as Saturn. */
  feelings: string[];
...
export const PLANETS: Record<string, PlanetEntry> = {
  Sun: {
    ...
    feelings: ["proud", "exposed", "unseen", "overlooked", "invisible", "unappreciated", "no credit", "prickly", "self-conscious", "dimmed", "small", "showing off", "need to be seen", "taking it personally", "glare", "centre of attention", "center of attention"],
  ...
  Moon: {
    ...
    feelings: ["tender", "raw", "weepy", "tearful", "homesick", "needy", "moody", "soft", "nostalgic", "sensitive", "hungry for comfort", "want comfort", "cosy", "cozy", "unsafe", "safe", "mothering", "looked after", "clingy", "hormonal", "in my feelings"],
  ...
  Mercury: {
    ...
    feelings: ["scattered", "racing thoughts", "overthinking", "can't think", "cant think", "too many tabs", "distracted", "chatty", "jittery", "buzzing", "wordy", "indecisive", "nervy", "looping", "the thought that keeps", "spinning out", "brain fog", "can't switch off"],
  ...
  Venus: {
    ...
    feelings: ["lonely", "longing", "unloved", "unlovable", "unattractive", "jealous", "indulgent", "people-pleasing", "avoiding the hard thing", "want closeness", "affectionate", "romantic", "miss them", "miss him", "miss her", "miss my", "left out", "want to be held", "touch starved"],
  ...
  Mars: {
    ...
    feelings: ["angry", "irritable", "irritated", "furious", "snapping", "snappy", "impatient", "aggressive", "competitive", "frustrated", "rage", "wound up", "combative", "on edge", "itching", "fight", "short fuse", "seething", "annoyed", "everyone is annoying", "want to hit"],
  ...
  Jupiter: {
    ...
    feelings: ["restless for more", "overcommitted", "overpromised", "over-promised", "bored", "hemmed in", "want adventure", "grandiose", "said yes too much", "cabin fever", "need a horizon", "too big for"],
  ...
  Saturn: {
    ...
    feelings: ["heavy", "hopeless", "bleak", "self-critical", "inadequate", "failing", "ashamed", "old", "stuck", "blocked", "grim", "joyless", "pressured", "burdened", "flat", "numb", "nothing matters", "depressed", "behind on everything", "not enough", "weight of it", "dread"],
