...
export const PLANETS: Record<string, PlanetEntry> = {
  Sun: {
    ...
    signification: "Visibility, leadership, vitality. Good for presenting yourself, making decisions, and creative assertion.",
  ...
  Moon: {
    ...
    signification: "Nourishment, care, routine. Tend to home, body, and emotional space.",
  ...
  Uranus: {
    ...
    literacy: {"adjective": "uranian", "undertone": "a uranian undertone — restlessness, static, the urge to break pattern", "feelsLike": "Uranian time is electric: sudden insights, itchiness inside routines, surprises in the schedule. Genuinely good for experiments and unsticking stuck things.", "shadow": "Its edge is disruption for its own sake — the impulsive quit, the 2am reinvention, anxiety wearing the costume of excitement.", "useIt": "Experiment, automate, rearrange, question a default. Give the restlessness a sandbox.", "weeklyNote": "When the Moon contacts Uranus (about weekly), days go a little static-charged — plans wobble, insights arrive sideways. Loosen the schedule that day rather than gripping it.", "longArc": "Uranus takes 84 years to circle the chart — its transits mark the awakening seasons, a year or more where one area of life refuses to stay in its old container. The mid-life 'Uranus opposition' (~age 42) is the classic one."},
