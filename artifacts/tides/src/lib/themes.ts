...
export const PALETTES: Palette[] = [
  {
    ...
    vars: {
      ...
      "--color-muted": "#8E8A7E",
      "--text-1": "#2E2C27", "--text-2": "#4E4B43", "--text-3": "#9A968A",
  ...
  },
  {
    ...
    vars: {
      ...
      "--color-muted": "#7A7259",
      "--text-1": "#3A3730", "--text-2": "#575143", "--text-3": "#8C8570",
  ...
  },
  {
    ...
    vars: {
      ...
      "--color-muted": "#8A93A6",
      "--text-1": "#DDE2EC", "--text-2": "#C2C9D6", "--text-3": "#98A1B2",
  ...
  },
  {
    ...
    vars: {
      ...
      "--color-muted": "#9A9A9A",
      "--text-1": "#222222", "--text-2": "#454545", "--text-3": "#8E8E8E",
