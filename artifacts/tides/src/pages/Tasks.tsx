  ...
  return (
    <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
      ...
      <div style={{flex:1,overflowY:"auto",padding:"16px 20px",display:"flex",flexDirection:"column",gap:12}}>
        ...
        {showAdd && (
          <div style={{background:"#fff",border:"1px solid #d0cbc3",borderRadius:10,padding:"14px 16px"}}>
...
function Row({ task, onToggle, onDelete, highlight, dim }: {task:Task;onToggle:()=>void;onDelete:()=>void;highlight?:boolean;dim?:boolean}) {
  ...
  return (
    <div style={{display:"flex",alignItems:"center",gap:8,padding:"6px 10px",borderRadius:7,border:`1px solid ${highlight?"#c0d8b0":"#e8e4de"}`,background:highlight?"#f5faf2":"#faf8f5",opacity:dim?0.5:1}}>
