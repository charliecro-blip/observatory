...
// `/tides/practices` lived here until 2026-08-15 — it scored the legacy
// cultivations table against the sky, a table no surface can populate since
// the 2026-07-09 habits merge, and the HOME study's M4 repointed its last
// consumers at habit resonance. The cultivations DATA stays in the database
// untouched; deleting a route is reversible, dropping a table is not.
